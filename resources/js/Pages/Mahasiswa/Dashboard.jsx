...
export default function Dashboard({ auth, bookings, upcomingBookings, stats }) {
    ...
    const getStatusColor = (status) => {
        switch (status.toLowerCase()) {
            case "approved":
                return "bg-success-light/50 text-green-800";
            case "pending":
                return "bg-warning-light/50 text-yellow-800";
            case "rejected":
                return "bg-danger-light/50 text-red-800";
            default:
                return "bg-disable-light/50 text-gray-800";
        }
    };
            ...
            <div className="py-8">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8 grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                            <div className="flex items-center">
                                <div className="p-2 bg-warning-light/50 rounded-lg">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                            <div className="flex items-center">
                                <div className="p-2 bg-success-light/50 rounded-lg">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                            <div className="flex items-center">
                                <div className="p-2 bg-danger-light/50 rounded-lg">
                                ...
                                <div className="p-6 border-b border-gray-200">
                                    ...
                                    <div className="space-y-4">
                                        <div className="p-4 bg-primary/5 rounded-lg">
                                            ...
                                            <ul className="text-sm text-gray-600 space-y-2">
                                                <li className="flex items-start">
                                                    ...
                                                    <span>
                                                        Bookings can be made up
                                                        to 7 days before usage
                                                    </span>
                                                </li>
                                                <li className="flex items-start">
                                                    <div className="w-1.5 h-1.5 bg-primary rounded-full mt-1.5 mr-2"></div>
                                        ...
                                        <div className="p-4 bg-yellow-50 rounded-lg">
                                            ...
                                            <p className="text-sm text-gray-600">
                                                Please ensure all booking
                                                details are filled completely
                                                and correctly to expedite the
                                                approval process.
                                            </p>
                                        </div>
                                    </div>
